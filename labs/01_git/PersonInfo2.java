public class PersonInfo2 {
    ...
    public static String firstName = "Mouna";
    public static String lastName = "Laouane";
    public static int studentNo = 300023986;
    public static String description = "Je ne suis pas n'importe quoi.";

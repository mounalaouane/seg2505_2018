public class PersonInfo1 {
    ...
    public static String firstName = "Brian";
    public static String lastName = "Laliberte";
    public static int studentNo = 300023551;
    public static String description = "Je suis n'importe quoi.";
